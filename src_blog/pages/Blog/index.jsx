...
class Blog extends Component {
    ...
    bloglists = [
        {
            id:1,
            icon:'https://www.runoob.com/wp-content/uploads/2015/07/5a7d00514af1e464221c677c15e8e990.png',
            title:'这是第一篇博客',
        ...
        {
            id:2,
            icon:'https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e7b86fcb576843f3b86a98f1e3b332bb~tplv-k3u1fbpfcp-zoom-mark-crop-v2:0:0:360:240.awebp',
            title:'这是第二篇博客',
            content:'布局的传统解决方案，基于盒状模型，比如，垂直居中就不容易实现',
            looknumber:99,
        },
